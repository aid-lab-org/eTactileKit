...
public class SaveToJson {
    ...
    public SaveToJson(PApplet parent, ETactile eTactile) {
        this.parent = parent;
    ...
    void saveJSONfile(JSONArray outer_array) {
        ...
        System.out.println("outer array size: " + outer_array.size());
        json.setJSONArray("Pattern_Data", outer_array);
        parent.saveJSONObject(json, eTactile.output_name + ".json");
    }
}
