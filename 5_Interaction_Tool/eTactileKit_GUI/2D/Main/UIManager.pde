...
class UIManager {
  ...
  void drawPage1() {
    ...
    int imgHeight = 148; 
    float n = 0.8;
    parent.image(img, 120, 160, n*imgWidth, n*imgHeight);
  }

  void drawPage3() {
    parent.textSize(14);
    parent.text("Display readings",750,  705);
    parent.textSize(18);
    parent.fill(255);
    parent.textAlign(PApplet.LEFT);
    //parent.text("Page 2: Summary and Start/Stop", 20, 30);
    parent.textSize(18);
    parent.text("COM Port: " + selectedCOMPort, 20, 40);
    parent.text("Select the pattern JSON: ", 20, 90);
    //parent.text("Pattern: " + array_, 20, 100);
    
    
    // Display the current frequency value
    int frequency = eTactile.stimulation_frequency;
    parent.text("Frequency: " + int(frequency) + " Hz", 800, 100);
    
    // Display the current polarity
    int polarity = eTactile.stimulation_polarity;
    String polarityText = (polarity == 1) ? "Anodic" : "Cathodic";
    parent.text("Polarity: " + polarityText, 800, 130);
    ...
    int xPosition = parent.width - 150;  // Set right-aligned margin
    int yPosition = parent.height - 250; // Start higher from bottom
  ...
  void drawPage2(){
    ...
    parent.textSize(15);
    parent.text("Height: " + lower_thresh_hight , 350, 780);
    parent.text("Width: " + lower_thresh_width , 350, 800);
    
    parent.text("Height: " + upper_thresh_hight , 550, 780);
    parent.text("Width: " + upper_thresh_width , 550, 800);
    
    int imgWidth = 881; 
    int imgHeight = 148; 
    float n = 0.2;
    parent.image(img, 40, 50, n*imgWidth, n*imgHeight);
  }
  ...
  void hidePage3UI() {
    ...
    cp5.getController("ShowNum").hide();
  ...
  void setupPage3UI() {
    ...
    cp5.addButton("backToPage1")
     ...
     frequencySlider = cp5.addSlider("stimulationFrequency")
        ...
        .setPosition(20, 750)                   // Set the position of the slider
    ...
    stimModeToggle = cp5.addToggle("polarityToggle")
       ...
       .setPosition(20, 700)  // Adjust the position as needed
      ...
      cp5.addSlider("channelDischargeTime")
        ...
        .setPosition(20, 780)                   // Set the position of the slider
        .setSize(200, 20)                       // Set the size of the slider (unchanged)
       ...
       cp5.addButton("ShowNum")
       .setLabel("Show numbers")
       .setPosition(890, 730)
       .setSize(80, 20)
       .setColorForeground(parent.color(70, 130, 180))
       .setColorBackground(parent.color(30, 144, 255))
