...
class LaserCutEditor(QWidget):
    def __init__(self, parent=None):
        super(LaserCutEditor, self).__init__(parent)
    ...
    def initUI(self):
        ...
        self.sidebar_widget.setObjectName("sidebar_widget_laser_cut")
        ...
        # Button to eraser drawn elements
        ...
        self.heading_electrodes = QLabel('Adjust Layout Parameters', self)
        ...
        self.trace_width.setText("0.5mm")
        self.trace_width.setFixedWidth(int(100*scale_x))        
        # self.trace_width.move(475, 55)     # Place the second input box finely
        self.trace_width.move(int(475*scale_x), int(55*scale_y))     # Place the second input box finely

        # Input box for Routing clearance
        self.routing_clearance = QLineEdit(overlay_widget)
        self.routing_clearance.setText("0.5mm")
        ...
        pixmap = QPixmap(f"{ICON_DIR}LaserCut_Connector_Dimensions")  # Path to the electrode layout image
        # Scale the image to fit the widget (you can customize the target width/height)
        ...
        # Input box for Connector Width
        self.pad_width = QLineEdit(overlay_widget)
        self.pad_width.setText("1mm")  # Default parameter
        self.pad_width.setFixedWidth(int(100*scale_x))  # Adjust as needed
        # self.pad_width.move(95, 5)  # Place the input box finely
        self.pad_width.move(int(95*scale_x), int(5*scale_y))  # Place the input box finely

        # Input box for Connector Height
        self.pad_height = QLineEdit(overlay_widget)
        self.pad_height.setText("4mm")
        self.pad_height.setFixedWidth(int(100*scale_x))
        # self.pad_height.move(65, 110)     # Place the second input box finely
        self.pad_height.move(int(65*scale_x), int(110*scale_y))     # Place the second input box finely

        # Input box for Gap Between Connectors
        self.pad_spacing = QLineEdit(overlay_widget)
        self.pad_spacing.setText("1mm")
        self.pad_spacing.setFixedWidth(int(100*scale_x))
        # self.pad_spacing.move(230, 195)     # Place the second input box finely
        self.pad_spacing.move(int(230*scale_x), int(195*scale_y))     # Place the second input box finely

        # Input box for Number of Connector Pads
        self.num_pads = QLineEdit(overlay_widget)
        self.num_pads.setText("5")
        self.num_pads.setFixedWidth(int(100*scale_x))
        # self.num_pads.move(250, 255)        # Place the second input box finely
        self.num_pads.move(int(250*scale_x), int(255*scale_y))        # Place the second input box finely
        ...
        self.draw_electrode_regions_button = QPushButton('Draw New Electrode Region')
...
class Viewer(QtInteractor):
    ...
    def load_image_to_canvas(self, plane, image):            
        ...
        # self.set_top_view()       # Reset the camera position to fit the mesh in the view
...
class AdjustElementsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.select_elements_to_move.setAutoDefault(False)  # disable Enter key
        ...
        # ------------------------------
        # 3) Middle Right: Step & Angle & Confirm Button
        # ------------------------------
        ...
        self.confirm_transformation_button.setAutoDefault(False)  # disable Enter key
