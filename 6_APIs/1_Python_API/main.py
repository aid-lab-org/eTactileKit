...
PORT_1_NAME = 'COM8'  #serial port for ET device
...
if __name__ == '__main__':
    ...
    etactilekit.send_stimulation_pulse_height(80)
    
    etactilekit.send_stimulation_pulse_width(50)
    ...
    etactilekit.send_stimulation_frequency(75)
